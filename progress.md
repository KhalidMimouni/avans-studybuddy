...
- [x] Overzichtspagina met studiegroepen
- [x] Per studiegroep minimaal titel, gekoppeld vak, locatie en maximale groepsgrootte zichtbaar
- [x] Vanuit het overzicht navigeren naar een detailpagina van een studiegroep
...
- [x] Overzichtspagina met studiesessies
- [x] Per sessie minimaal titel, datum, begin- en eindtijd en gekoppelde studiegroep zichtbaar
- [x] Vanuit het overzicht navigeren naar een detailpagina van een studiesessie
...
- [x] Alleen ingelogde gebruikers mogen een studiegroep aanmaken
- [x] Bij het aanmaken: titel, beschrijving, locatie, max leden, gekoppeld vak
- [x] De aangemaakte studiegroep wordt zichtbaar in het overzicht
